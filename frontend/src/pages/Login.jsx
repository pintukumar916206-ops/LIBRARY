    ...
    <div className="h-screen flex flex-col items-center justify-center md:flex-row">
      <div className="w-full md:w-1/2 flex items-center justify-center p-9 relative overflow-hidden">
        <div className="max-w-sm w-full">
          ...
          <h1 className="text-4xl font-medium text-center mb-2 overflow-hidden">WELCOME BACK!</h1>
          <p className="text-gray-800 text-center mb-12">Enter your email and password to continue.</p>
          <form onSubmit={handleLogin}>
            ...
            <div className="block md:hidden font-semibold mt-5">
              <p>New here? <Link to="/register" className="text-sm text-gray-500 hover:underline">Sign Up</Link></p>
            </div>
            <button
              type="submit"
              disabled={loading}
