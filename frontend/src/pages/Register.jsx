    ...
    <div className="flex flex-col md:flex-row h-screen overflow-hidden">
      <div className="hidden w-full md:w-1/2 bg-black text-white md:flex flex-col items-center justify-center p-8 rounded-tr-[80px] rounded-br-[80px]">
        <div className="text-center h-[375px]">
          ...
          <Link to="/login" className="border-2 rounded-lg py-2 font-semibold border-white px-8 hover:bg-white hover:text-black transition">SIGN IN</Link>
        </div>
      </div>
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-6 overflow-hidden">
        <div className="w-full max-w-sm">
          ...
          <p className="text-gray-800 text-center mb-12">Fill in your details to create an account.</p>
          <form onSubmit={handleRegister}>
            ...
            <div className="block md:hidden font-semibold mt-5">
              <p>Already have an account? <Link to="/login" className="text-sm text-gray-500 underline">Sign In</Link></p>
            </div>
            <button
              type="submit"
              disabled={loading}
