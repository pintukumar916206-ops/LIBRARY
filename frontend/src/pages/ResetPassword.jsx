    ...
    <div className="flex flex-col md:flex-row h-screen justify-center">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
        ...
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-4xl font-medium text-center mb-2 overflow-hidden">Reset Password</h1>
          <p className="text-gray-800 text-center mb-12">Enter your new password below.</p>
