  ...
  return (
    <>
      <aside
        ...
        } md:translate-x-0 md:relative overflow-y-auto custom-scrollbar`}
      >
        ...
        <nav className="flex-1 px-6 space-y-2">
          ...
          {isAuthenticated && user?.role?.toLowerCase() === ROLES.ADMIN && (
            <>
              <button
          ...
          {isAuthenticated && user?.role?.toLowerCase() === ROLES.USER && (
            <button
